...
Description:	Copy Of ModelBase from JCHVRFNew.Helpers. So that we don't need to refer JCHVRF New
\*************************************************************************/
...
namespace JCHVRF.Model
{
    ...
    public class ModelBase : INotifyPropertyChanged, INotifyDataErrorInfo
    {
        ...
        public int ValidPropertiesCount
        {
            get
            {
                return this.validators == null ? 0 : this.validators.Where(validator => validator.Value.All(attribute => attribute.IsValid(this.propertyGetters[validator.Key](this)))).Count();
            }
        }
        ...
        public int TotalPropertiesWithValidationCount
        {
            get
            {
                return this.validators == null ? 0 : this.validators.Count();
            }
        }
