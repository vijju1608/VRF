...
namespace JCHVRF.Model.NextGen
{
    ...
    {
        public static T GetProperyValue<T>(this object obj, string name)
        {
    ...
    [Serializable]
    public class JCHNode : Node, INotifyPropertyChanged
    {
        public JCHNode(JCHNode other) : base(other.Location.X, other.Location.Y, other.Size.Width, other.Size.Height, other.ImageData?.NodeNo.ToString(), other.AddFlow)
        {
        ...
        public JCHNode(double left, double top, double width, double height, string text, Node node) : base(left, top, width, height, text, node)
        {

        }
        public JCHNode(double left, double top, double width, double height, string text, AddFlow addflow)
            : base(left, top, width, height, text, addflow)
        {

        }

        public bool IsLiquidGasPipeNode { get; set; }       
    ...
    [Serializable]
    public class MyNode : JCHNode
    {
        public MyNode(MyNode other) : base(other)
        {
            this.ParentNode = other.ParentNode;
            this.MyInLinks = other.MyInLinks;
            this.NeedSizeUP = other.NeedSizeUP;
        }
    ...
    public class MyNodeOut : MyNode,ISingleChild<Node>
    {
        ...
        private int _nodeNo;
        public int NodeNo { get { return _nodeNo; } set { _nodeNo = value; } }


        private string _uniqName;
        public string UniqName { get { return _uniqName; } set { _uniqName = value; } }
    ...
    public class MyNodeYP : MyNode, ICoolingonly, IChildNodeArray<Node>
    {
        ...
        public MyNodeYP(int maxOutlinksCount)
        {
            this._coolingCapacity = 0;
            this._isCP = true;
            this._maxCount = maxOutlinksCount;
            this._childCount = 0;
            this._isCoolingonly = false;
            if (_childNodes == null)
            {
        ...
        static readonly System.Windows.DependencyProperty InLetIdProperty =
            System.Windows.DependencyProperty.RegisterAttached("InLetId", typeof(string), typeof(Node),
                new System.Windows.PropertyMetadata(""));
        public static string GetInLetId(System.Windows.DependencyObject node)
        {
            if (node == null)
            {
                return "";
            }
            return (string)node.GetValue(InLetIdProperty);
        }
        public static void SetInLetId(System.Windows.DependencyObject node, string value)
        {
            if (node != null)
            {
                node.SetValue(InLetIdProperty, value);
            }
        }
        static readonly System.Windows.DependencyProperty BottomOutletIdProperty =
            System.Windows.DependencyProperty.RegisterAttached("BottomOutletId", typeof(string), typeof(Node),
                new System.Windows.PropertyMetadata(""));
        public static string GetBottomOutletId(System.Windows.DependencyObject node)
        {
            if (node == null)
            {
                return "";
            }
            return (string)node.GetValue(BottomOutletIdProperty);
        }
        public static void SetBottomOutletId(System.Windows.DependencyObject node, string value)
        {
            if (node != null)
            {
                node.SetValue(BottomOutletIdProperty, value);
            }
        }
        static readonly System.Windows.DependencyProperty RightOutletIdProperty =
            System.Windows.DependencyProperty.RegisterAttached("RightOutletId", typeof(string), typeof(Node),
                new System.Windows.PropertyMetadata(""));
        public static string GetRightOutletId(System.Windows.DependencyObject node)
        {
            if (node == null)
            {
                return "";
            }
            return (string)node.GetValue(RightOutletIdProperty);
        }
        public static void SetRightOutletId(System.Windows.DependencyObject node, string value)
        {
            if (node != null)
            {
                node.SetValue(RightOutletIdProperty, value);
            }
        }
        #endregion
        ...
        private string _yBranchOrientation;
        public string YBranchOrientation
        {
            get { return _yBranchOrientation; }
            set { _yBranchOrientation = value; }
        }
        
        public enum BranchOrientations
        {
            Horizontal = 1,
            HorizontalMirror = 2,
            Vertical = 3,
    ...
    /// 配管图--CH-BOX 兼容wiring
    /// </summary>
    public class MyNodeCH : MyNodeCHBase, ISingleChild<Node>
    {
        public MyNodeCH()
        {
        }

        public MyNodeCH(MyNodeCH other) : base(other)
        {
            this._childNode = other.ChildNode;
        }

        public MyNodeCH(MyNodeCHBase other)
            : base(other)
        {
        }
    ...
    /// 配管图--CH-BOX 兼容wiring
    /// </summary>
    public class MyNodeMultiCH : MyNodeCHBase
    {
        public MyNodeMultiCH(MyNodeMultiCH other)
            : base(other)
        {
            this._childNodes = other.ChildNodes;
            this.MaxBranches = other.MaxBranches;
            this.MaxCapacityPerBranch = other.MaxCapacityPerBranch;
            this.MaxIUPerBranch = other.MaxIUPerBranch;
        }

        public MyNodeMultiCH(MyNodeCHBase other)
            : base(other)
        {
        }
    ...
    /// <summary>
    /// Base Class for Both Type Of CHBox Nodes
    /// </summary>
    public class MyNodeCHBase : MyNode
    {
        public MyNodeCHBase()
        {
        ...
        public MyNodeCHBase(MyNodeCHBase other) : base(other)
        {
            this.PowerSupply = other.PowerSupply;
            this.PowerConsumption = other.PowerConsumption;
            this.PowerCurrent = other.PowerCurrent;
            this.PowerLineType = other.PowerLineType;
            this.HeightDiff = other.HeightDiff;
            this.CoolingCapacity = other.CoolingCapacity;
            this.HeatingCapacity = other.HeatingCapacity;
            this.MaxIndoorCount = other.MaxIndoorCount;
            this.HorsePower = other.HorsePower;
            this.Model = other.Model;
            this.ActualTotalCHIndoorPipeLength = other.ActualTotalCHIndoorPipeLength;
            this.MaxTotalCHIndoorPipeLength = other.MaxTotalCHIndoorPipeLength;
            this.MaxTotalCHIndoorPipeLength_MaxIU = other.MaxTotalCHIndoorPipeLength_MaxIU;
        }
        ...
        public double ActualTotalCHIndoorPipeLength { get; set; }
        public double MaxTotalCHIndoorPipeLength { get; set; }
        public double MaxTotalCHIndoorPipeLength_MaxIU { get; set; }
        public int MaxIndoorCount { get; set; }
    }
    ...
    public class MyNodePlottingScale : MyNode
    {
        ...
        public System.Windows.Media.SolidColorBrush PlottingScaleColor { get; set; }
    ...
    public class MyLink : Link
    {
        public MyLink()
        { }
        public MyLink(Node parent, Node child, string LinkName, AddFlow addFlow) : base(parent, child, LinkName, addFlow)
        { }

        public MyLink(Node parent, Node child, int orgIndex, int dstIndex, string LinkName, AddFlow addFlow) : base(parent, child, orgIndex, dstIndex, LinkName, addFlow)
        { }
        ...
        private int pinOriginIndex;
        public int PinOriginIndex
        {
            get { return pinOriginIndex; }
            set { pinOriginIndex = value; }
        }
        private int pinDestinationIndex;
        public int PinDestinationIndex
        {
            get { return pinDestinationIndex; }
            set { pinDestinationIndex = value; }
        }
    }
    ...
    public class tmpMyNodeOut : tmpMyNode, ISingleChild<tmpMyNode>
    {
        ...
        [NonSerialized]
        public System.Windows.Media.Brush pipeColor;
        [NonSerialized]
        public System.Windows.Media.Brush textColor;
        [NonSerialized]
        public System.Windows.Media.Brush branchKitColor;
        [NonSerialized]
        public System.Windows.Media.Brush nodeBgcolor;
    ...
    public class tmpMyNodeYP : tmpMyNode, IChildNodeArray<tmpMyNode>
    {
        ...
        public tmpMyNodeYP(int maxOutlinksCount)
        {
            this._coolingCapacity = 0;
            this._isCP = true;
            this._maxCount = maxOutlinksCount;
    ...
    [Serializable]
    public class tmpMyNodeMultiCH : tmpMyNode
    {
    ...
    public class WiringNode : MyNode
    {
        ...
        public Node PositiveControlContact { get; set; }
        public Node NegativeControlContact { get; set; }
    ...
    public class AutoWiringNodeGroup : Node
    {
        public List<WiringNodeCentralControl> ControllerListLevel1 = new List<WiringNodeCentralControl>();
        public List<WiringNodeCentralControl> ControllerListLevel2 = new List<WiringNodeCentralControl>();
        public List<WiringNodeCentralControl> ControllerListOthers = new List<WiringNodeCentralControl>();
        public List<WiringNodeCentralControl> SystemList = new List<WiringNodeCentralControl>();
    }
    ...
    public class ImageData : ModelBase
    {
        ...
        public string controllerLayoutType { get; set; }//added for controllers only
        public int NodeNo { get; set; }   // Added to uniquely identify the node
        public string SysStatusIcon { get; set; }
