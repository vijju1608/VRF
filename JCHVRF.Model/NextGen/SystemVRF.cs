...
namespace JCHVRF.Model.NextGen
{
    ...
    /// </summary>
    [Serializable]
    public class SystemVRF : SystemBase
    {
        #region 构造函数
        ...
        public SystemVRF()
        {
            ...
            ControlGroupID = new List<string>();
        }
        #endregion
        ...
        /// </summary>
        /// 
        private string _displayImageName;
        public string DisplayImageName
        {
            get { return _displayImageName; }
            set { this.SetValue(ref _displayImageName, value); }
        }

        //ProductType
        private bool _isOutDoorUpdated;

        public bool IsOutDoorUpdated
        {
            get { return _isOutDoorUpdated; }
            set { _isOutDoorUpdated = value; }
        }
        ...
        //bug 4244
        private string _productSeries;
        public string ProductSeries
        {
            get { return _productSeries; }
            set { this.SetValue(ref _productSeries, value); }
        }
        //bug 4244
        ...
        public string ProductCategory
        {
            ...
            set { this.SetValue(ref _productCategory, value); }
        }
        ...
        public List<tmpMyNodeIn> MyPipingOrphanNodesTemp = null;
        [NonSerialized]
        public List<MyNodeIn> MyPipingOrphanNodes = null;
        /// <summary>
        ...
        public bool editrpt = false;
        public bool _editreportapply; 
        /// <summary>
        /// 是否输出到报告文件
        /// </summary>
        ...
        public bool IsPipingOK
        {
            ...
            set
            {
                this.SetValue(ref _isPipingOK, value);
                SystemStatus = value ? SystemStatus.VALID : SystemStatus.WIP;
            }
        }
        ...
        public List<string> ControlGroupID
        {
            ...
            set { this._controlGroupID = value; }
        }
        ...
        public double GetTotalIndoorEstCapacity(ref Project thisProject)
        {
            ...
            {
                if (ri.IndoorItem != null && ri.SystemID == this.Id)
                {
        ...
        public void SetControlGroupID(string value)
        {
            _controlGroupID.Add(value);
        }

        private string _systemTypeNexGen;
        /// <summary>
        /// 系统类型，OnlyIndoor等等
        /// </summary>
        public string SystemTypeNexGen
        {
            get { return _systemTypeNexGen; }
            set { this.SetValue(ref _systemTypeNexGen, value); }
        }
        ...
        {
            get { return _isActiveSYstem; }
            set { this.SetValue(ref _isActiveSYstem, value); }
        }
        ...
        /// </summary>
        /// <returns></returns>
        public SystemVRF DeepCopy()
        {
            var clone = (SystemVRF)this.MemberwiseClone();
            clone.OutdoorItem = new Outdoor
            {
                ProductType = this.OutdoorItem.ProductType,
                Series = this.OutdoorItem.Series,
                MaxRatio = this.OutdoorItem.MaxRatio,
                TypeImage = this.OutdoorItem.TypeImage,
                Type = this.OutdoorItem.Type
            };
            return clone;
        }

        public JCHVRF.Model.SystemVRF ToOldSystem()
        {
            JCHVRF.Model.SystemVRF systemVRF = new JCHVRF.Model.SystemVRF();
            systemVRF.AddRefrigeration = this._addRefrigeration;
            systemVRF.AllowExceedRatio = this._allowExceedRatio;
            systemVRF.SetControlGroupID(this._controlGroupID);
            systemVRF.CoolingCapacity = this._coolingCapacity;
            systemVRF.DBCooling = this._dbCooling;
            systemVRF.DBHeating = this._dbHeating;
            systemVRF.RHHeating = this._rhHeatling;
            systemVRF.DiversityFactor = this._diversityFactor;
            systemVRF.FirstPipeLength = this._firstPipeLength;
            systemVRF.FirstPipeLengthbuff = this._firstPipeLengthbuff;
            systemVRF.HeatingCapacity = this._heatingCapacity;
            systemVRF.HeightDiff = this._heightDiff;
            systemVRF.IsExportToReport = this._isExportToReport;
            systemVRF.editreportapply = this._editreportapply;
            systemVRF.IsPipingOK = this._isPipingOK;
            systemVRF.IsUpdated = this._isUpdated;
            systemVRF.IWCooling = this._iwCooling;
            systemVRF.IWHeating = this._iwHeating;
            systemVRF.MaxDiffIndoorHeight = this._MaxDiffIndoorHeight;
            systemVRF.MaxDiffIndoorLength = this._MaxDiffIndoorLength;
            systemVRF.MaxEqPipeLength = this._MaxEqPipeLength;
            systemVRF.MaxIndoorLength = this._MaxIndoorLength;
            systemVRF.MaxOutdoorAboveHeight = this._MaxOutdoorAboveHeight;
            systemVRF.MaxOutdoorBelowHeight = this._MaxOutdoorBelowHeight;
            systemVRF.MaxPipeLength = this._MaxPipeLength;
            systemVRF.MaxPipeLengthwithFA = this._MaxPipeLengthwithFA;
            systemVRF.MaxRatio = this._maxRatio;
            systemVRF.Name = this.Name;
            systemVRF.NO = this._no;
            systemVRF.OptionItem = this._optionItem;
            systemVRF.PipeActualLength = this._pipeActualLength;
            systemVRF.PipeEquivalentLength = this._pipeEquivalentLength;
            systemVRF.PipeEquivalentLengthbuff = this._pipeEquivalentLengthbuff;
            systemVRF.MaxPipeLengthwithFA = this._pipingLengthFactor;
            systemVRF.PipingPositionType = this._pipingPositionType;
            systemVRF.Ratio = this._ratio;
            systemVRF.RatioFA = this._ratioFA;
            systemVRF.SelOutdoorType = this._selOutdoorType;
            systemVRF.SysType = this._sysType;
            systemVRF.WBHeating = this._wbHeating;
            systemVRF.OutdoorItem = this.OutdoorItem;
            systemVRF.IDUFirst = this._IDUFirst;

            systemVRF.IsAuto = this._isAuto;
            systemVRF.CoolingFlowRate = this._coolingFlowRate;
            systemVRF.HeatingFlowRate = this._heatingFlowRate;
            systemVRF.FlowRateLevel = this._flowRateLevel;
            systemVRF.Id = this.Id;

            //添加新的属性  add by Shen Junjie on 2018/02/01
            systemVRF.MaxTotalPipeLength = this.MaxTotalPipeLength;
            //systemVRF.MaxTotalPipeLength_MaxIU = this.MaxTotalPipeLength_MaxIU;
            systemVRF.MaxMKIndoorPipeLength = this.MaxMKIndoorPipeLength;
            //systemVRF.MaxMKIndoorPipeLength_MaxIU = this.MaxMKIndoorPipeLength_MaxIU;
            //添加新的属性  add by xyj on 2018/06/25
            systemVRF.MaxSameCHBoxHighDiffLength = this.MaxSameCHBoxHighDiffLength;
            systemVRF.MaxCHBoxHighDiffLength = this.MaxCHBoxHighDiffLength;
            systemVRF.MaxCHBox_IndoorHighDiffLength = this.MaxCHBox_IndoorHighDiffLength;
            systemVRF.MaxIndoorHeightDifferenceLength = this.MaxIndoorHeightDifferenceLength;
            systemVRF.MaxLowerHeightDifferenceLength = this.MaxLowerHeightDifferenceLength;
            systemVRF.MaxUpperHeightDifferenceLength = this.MaxUpperHeightDifferenceLength;
            systemVRF.NormalCHBoxHighDiffLength = this.NormalCHBoxHighDiffLength;
            systemVRF.NormalCHBox_IndoorHighDiffLength = this.NormalCHBox_IndoorHighDiffLength;
            systemVRF.NormalSameCHBoxHighDiffLength = this.NormalSameCHBoxHighDiffLength;
        ...
        private string _addflowBackgroundImage;
        public string AddFlowBackgroundImage
        {
            get { return _addflowBackgroundImage; }
            set { this.SetValue(ref _addflowBackgroundImage, value); }
        }
        private int _BackgroundImageOpacity;
        public int BackgroundImageOpacity
        {
            get { return _BackgroundImageOpacity; }
            set { this.SetValue(ref _BackgroundImageOpacity, value); }
        }
        //BUG # 4695 : Added new property to handle odu series flips.
        public bool IsODUDirty { get; set; }
    }
}
