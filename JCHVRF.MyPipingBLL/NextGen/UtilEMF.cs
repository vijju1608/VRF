...
namespace JCHVRF.MyPipingBLL.NextGen
{
    ...
    public class UtilEMF
    {
        ...
        //comment code after take latest
        // public Font textFont_piping = new Font("Arial", 6f, FontStyle.Regular); // 12f
        #region new change take after latest code
        public Font textFont_piping = new Font("Arial", 6f, System.Drawing.FontStyle.Regular); // 12f
        #endregion new methods change take after latest code
        ...
        #region new change take after latest code
        public Font textFont_wiring = new Font("Arial", 8f, System.Drawing.FontStyle.Regular);
        #endregion new change take after latest code
        ...
        {
            ptText = new PointF(Convert.ToInt64(nd.Location.X), Convert.ToInt64(nd.Location.Y));
            Color color = getMediaColor(nd);
            Brush brush = new SolidBrush(color);
            g.TextRenderingHint = System.Drawing.Text.TextRenderingHint.SingleBitPerPixelGridFit;
            Font ft = new Font("Arial", 8f, System.Drawing.FontStyle.Regular);
            g.DrawString(nd.Text, font, brush, ptText, StringFormatForTextReport);

        }
        static Font font = new Font("Arial Narrow", 8f, System.Drawing.FontStyle.Regular);
        public System.Drawing.Color getMediaColor(Node nd)
        {
            Color color = Color.FromArgb(((System.Windows.Media.SolidColorBrush)nd.Foreground).Color.A, ((System.Windows.Media.SolidColorBrush)nd.Foreground).Color.R, ((System.Windows.Media.SolidColorBrush)nd.Foreground).Color.G, ((System.Windows.Media.SolidColorBrush)nd.Foreground).Color.B);
            return color;
        }

        public System.Drawing.Color getMediaColor(Caption nd)
        {
            Color color = Color.FromArgb(((System.Windows.Media.SolidColorBrush)nd.Foreground).Color.A, ((System.Windows.Media.SolidColorBrush)nd.Foreground).Color.R, ((System.Windows.Media.SolidColorBrush)nd.Foreground).Color.G, ((System.Windows.Media.SolidColorBrush)nd.Foreground).Color.B);
            return color;
        }
        ...
        public void DrawItemRecursion(Graphics g, Item item, string WiringImageDir)
        {
            ...
            //    {
            //        MyNodeGround_Wiring ndGnd = item as MyNodeGround_Wiring;                            // To be Fix latter
        ...
        public void DrawNode(Graphics g, Node nd)
        {
            ...
            //    string text = nd.Text;
            //    if (nd.DrawColor.R != 255 || nd.DrawColor.G != 255 || nd.DrawColor.B != 255)              // To be Fix latter
            //    {
            ...
            //{ 
            //    if (lnk.Stroke != System.Windows.Media.Brushes.Transparent)
            //    {
        ...
        public void DrawNodeNextGen(Graphics g, Node nd)
        {
            nd.Geometry = new System.Windows.Media.RectangleGeometry(new Rect(0, 0, 61, 65), 3, 3);
            PointF pt = new PointF(Convert.ToInt64(nd.Location.X), Convert.ToInt64(nd.Location.Y));
            SizeF s1 = new SizeF(Convert.ToInt64(nd.Size.Width), Convert.ToInt64(nd.Size.Height));
            RectangleF recf = new RectangleF(pt, s1);


            //  NodeShapeStyle obj = new NodeShapeStyle();
            if (nd == null) return;
            //Brushes obj = new Brushes();
            //public Brush textBrush_piping = new SolidBrush(Color.Black);

            //RectangleF rect = new RectangleF(nd.Location, nd.Size);
            string text = nd.Text;
            if (Color.Brown.R != 255)
            {
                // Pen pen = new Pen(Color.Black)
                Pen pen = new Pen(Color.Black, 0.1f * 0.1f);
                //Pen pen = new Pen(nd.DrawColor, nd.DrawWidth * 0.1f); //nd.DrawColor
                //pen.DashStyle = nd.DashStyle;
                //if (pen.DashStyle == DashStyle.Dash)
                //{
                ...
                //System.Windows.Media.Geometry obj = new System.Windows.Media.Geometry();

                if (nd.Geometry.GetType().Name == "RectangleGeometry")
                {
                    //g.DrawRectangle(pen, rect.X, rect.Y, rect.Width, rect.Height);
                    Rectangle rect = new Rectangle(Convert.ToInt32(nd.Bounds.X), Convert.ToInt32(nd.Bounds.Y), Convert.ToInt32(nd.Bounds.Width), Convert.ToInt32(nd.Bounds.Height));
                    g.DrawRectangle(pen, rect.X, rect.Y, rect.Width, rect.Height);
                }
                //else if (nd.Shape.Style == ShapeStyle.Connector)
                //{
            ...
            //判断是不是 Transparent或者White，但是nd.FillColor == Color.White的判断方法不够准确
            if (Color.Brown.G != 255)
            {
                //Brush brush = new SolidBrush(nd.FillColor);
                Brush textBrush_piping = new SolidBrush(Color.Black);
                Rectangle rect = new Rectangle(Convert.ToInt32(nd.Bounds.X), Convert.ToInt32(nd.Bounds.Y), Convert.ToInt32(nd.Bounds.Width), Convert.ToInt32(nd.Bounds.Height));
                if (nd.Geometry.GetType().Name == "RectangleGeometry")
                {
            ...
            {
                // Font ft = nd.Font;
                Font ft = new Font("Arial", 6f, System.Drawing.FontStyle.Regular);
                ...
                //        break;
                //}
                g.DrawString(text, ft, new SolidBrush(Color.Black), x, y);
            }
        }
        //commented code due to zero reference 
        //public void DrawLink(Graphics g, Link lnk)
        //{
        //    if (lnk.Stroke != System.Windows.Media.Brushes.Transparent)
        //    {
        ...
        //public void DrawNodeNextGen(Graphics g, Node nd, string nodeImageFile)
        //{
        //    DrawNodeNextGentest(g, nd);
        ...
        /// <param name="model">shortModel</param>
        /// <param name="name">out1</param>
        public void DrawNode_OutdoorGroup(Graphics g, Node nd, string nodeImageFile, string model, string name, JCHVRF.Model.NextGen.NodeElement_Piping item, bool isInch)
        {
            //DrawNode(g, nd);
            ...
            //    for (int i = 0; i < ptStart.Count; ++i)
            //    {
            //        g.DrawLine(pen_piping, ptStart[i], ptEnd[i]);                                           // To be Fix latter
            //    }
            //}
            //g.ResetTransform();
        ...
        //    PointF[] ptf = { pt1, pipingUtil.getRightTopPointF(nd), pipingUtil.getRightBottomPointF(nd), pt1 };               // To be Fix latter
        ...
        //Pen pen = new Pen(line.DrawColor, 0.1f);                // To be Fix latter
        //Node nd = line.Dst;
        ...
        public void DrawNode_wiring(Graphics g, Node nd, string nodeTextFile, string name, NodeElement_Wiring item)
        {
            ...
            //System.Windows.Size ndSize = new System.Windows.Size(nd.Size.Width, nd.Size.Height);
            //System.Windows.Point ndLocation = new System.Windows.Point(nd.Location.X, nd.Location.Y);                      // To be Fix latter
            //if (nd is WiringNodeIn)
            //{
            //    ndLocation = new System.Windows.Point(nd.Location.X, nd.Location.Y);
            //}

            //RectangleF rect = new Rectangle(ndLocation, ndSize);
        ...
        public void DrawActualCapacityText(Graphics g, Node nd)
        {
            ...
            //{
            //    g.DrawString(ArrayTxt[i], textFont_piping, textBrush_piping, pt);      // To be Fix latter
        ...
        public void DrawLabelText(Graphics g, Node nd)
        {
            ...
            ptText = new PointF(Convert.ToInt64(nd.Location.X -2), Convert.ToInt64(nd.Location.Y+3));
            Color color = getMediaColor(nd);
            Brush brush = new SolidBrush(color);
            g.TextRenderingHint = System.Drawing.Text.TextRenderingHint.SingleBitPerPixelGridFit;
            Font ft = new Font("Arial", 8f, System.Drawing.FontStyle.Regular);
            g.DrawString(nd.Text, ft, brush, ptText, StringFormatForTextReport);

        }

        public void DrawLabelText(Graphics g, Caption nd)
        {
            if (nd == null || nd.Text == null)
            {
                return;
        ...
        public void DrawYPNextGen(Graphics g, Node nd, bool isCP)
        {
            PointF pt = new PointF(Convert.ToInt64(nd.Location.X), Convert.ToInt64(nd.Location.Y));
            SizeF s1 = new SizeF(Convert.ToInt64(nd.Size.Width), Convert.ToInt64(nd.Size.Height));
            RectangleF recf = new RectangleF(pt, s1);
            ...
            if (!isCP)
            {
                PointF pt1 = pipingUtil.getLeftCenterPointFNextGen(nd);
                PointF[] ptf = { pt1, pipingUtil.getRightTopPointFNextGen(nd), pipingUtil.getRightBottomPointFNextGen(nd), pt1 };
                #region CADImportNet 不支持 DrawPolygon 方法绘制的图形
                g.DrawPolygon(pen, ptf);
                g.FillPolygon(Brushes.LightSkyBlue, ptf, FillMode.Winding); //OK
                #endregion
                g.DrawLines(pen, ptf);
                g.FillPolygon(Brushes.LightSkyBlue, ptf); //OK
        ...
        public void DrawLine(Graphics g, Link line)
        {
            ...
            {
                if(org is NextGenModel.MyNodeYP && dst is NextGenModel.MyNodeYP&&i==ptl.Count-1)
                    ptf[i] = new PointF(Convert.ToInt64(ptl[i].X + 5), Convert.ToInt64(ptl[i].Y));
                else
                    ptf[i] = new PointF(Convert.ToInt64(ptl[i].X-4), Convert.ToInt64(ptl[i].Y));
            }
            ...
            try
            {
                System.Drawing.Color c = System.Drawing.ColorTranslator.FromHtml(Convert.ToString(line.Stroke));
                pen = new Pen(c, 0.1f);
            }
        ...
        public void DrawNode_wiringNextGen(Graphics g, Node nd, string nodeTextFile, string name, NodeElement_Wiring item)
        {
            //Pen pen = pen_wiring;
            ...
            System.Windows.Size ndSize = new System.Windows.Size(nd.Size.Width, nd.Size.Height);
            System.Drawing.Point ndLocation = new System.Drawing.Point(Convert.ToInt32(nd.Location.X), Convert.ToInt32(nd.Location.Y));                      // To be Fix latter
            if (nd is NextGenModel.WiringNodeIn)
            {
                System.Drawing.Point ndpoint = new System.Drawing.Point(Convert.ToInt32(nd.Location.X + ndSize.Width / 3.5), Convert.ToInt32(nd.Location.Y + ndSize.Height / 3));
                Font ft = new Font("Arial Narrow", 7.5f, System.Drawing.FontStyle.Regular);
                g.DrawString(nd.Text, ft, textBrush_wiring, ndpoint);
            }
            

            PointF pt = new PointF(Convert.ToInt64(nd.Location.X-15), Convert.ToInt64(nd.Location.Y));
            SizeF s1 = new SizeF(Convert.ToInt64(nd.Size.Width+24), Convert.ToInt64(nd.Size.Height));
            RectangleF rect = new RectangleF(pt, s1);
            //RectangleF rect = new Rectangle(ndLocation, ndSize);
            //RectangleF rect = new RectangleF(ndLocation, item.NodeSize);
            // 根据机组图片的坐标集合文件绘制机组的线条图
            InitPointF(nodeTextFile);
            ...
            if (item != null && item.PtCircles.Count >= item.UnitCount * 4)
            {
                System.Windows.Point itempt = new System.Windows.Point(item.PtStr1.X, item.PtStr1.Y);
                System.Windows.Point ndLocationpt = new System.Windows.Point(ndLocation.X, ndLocation.Y);
                System.Windows.Point OffsetLocationPoint = OffsetLocation(itempt, ndLocationpt);
                //  g.DrawString(item.Str1, textFont_wiring, textBrush_wiring, OffsetLocation(item.PtStr1, ndLocation));
                // g.DrawString(item.Str1, textFont_wiring, textBrush_wiring, new PointF((float)OffsetLocationPoint.X, (float)OffsetLocationPoint.Y));

                for (int i = 0; i < item.UnitCount; ++i)
                {
                    //PointF pt = new PointF(Convert.ToInt64(nd.Location.X), Convert.ToInt64(nd.Location.Y));
                    //SizeF s1 = new SizeF(Convert.ToInt64(nd.Size.Width), Convert.ToInt64(nd.Size.Height));
                    //RectangleF r1 = new RectangleF(pt, s1);
                    ...
                    System.Windows.Point PtModelGroup = new System.Windows.Point(item.PtStr1.X, item.PtStr1.Y);
                    ndLocationpt = new System.Windows.Point(ndLocation.X, ndLocation.Y);
                    OffsetLocationPoint = OffsetLocation(PtModelGroup, ndLocationpt);

                    //       g.DrawString(item.ModelGroup[i], textFont_wiring, textBrush_wiring, new PointF((float)OffsetLocationPoint.X, (float)OffsetLocationPoint.Y));      // YVOH200
                    //if (i < 2)
                    //{
                    //    System.Windows.Point PtStrGroup1 = new System.Windows.Point(item.PtStr1.X, item.PtStr1.Y);
                    //    ndLocationpt = new System.Windows.Point(ndLocation.X, ndLocation.Y);
                    //    OffsetLocationPoint = OffsetLocation(PtStrGroup1, ndLocationpt);
                    //    g.DrawString(item.StrGroup1[i], textFont_wiring, textBrush_wiring, new PointF((float)OffsetLocationPoint.X, (float)OffsetLocationPoint.Y));
                    //    /*g.DrawString(item.StrGroup1[i], textFont_wiring, textBrush_wiring, OffsetLocation(item.PtStrGroup1[i], ndLocation)); */   // X Y | X Y
                    //}

                    System.Windows.Point PtStrGroup2 = new System.Windows.Point(item.PtStr1.X, item.PtStr1.Y);
                    ndLocationpt = new System.Windows.Point(ndLocation.X, ndLocation.Y);
                    OffsetLocationPoint = OffsetLocation(PtStrGroup2, ndLocationpt);
                    /* g.DrawString(item.StrGroup2[i], textFont_wiring, textBrush_wiring, new PointF((float)OffsetLocationPoint.X, (float)OffsetLocationPoint.Y));   */     // L1L2L3N

                    if (item.UnitCount > 1)
                    {
                        System.Windows.Point PtStrGroup3 = new System.Windows.Point(item.PtStr1.X, item.PtStr1.Y);
                        ndLocationpt = new System.Windows.Point(ndLocation.X, ndLocation.Y);
                        OffsetLocationPoint = OffsetLocation(PtStrGroup3, ndLocationpt);
                        try
                        {
                            if (item.StrGroup3.Length - 1 == i)
                                g.DrawString(item.StrGroup3[i], textFont_wiring, textBrush_wiring, new PointF((float)OffsetLocationPoint.X, (float)OffsetLocationPoint.Y));
                        }
                        catch (Exception ex)
                        {
        ...
        public void DrawNodeNextGenPiping(Graphics g, Node nd)
        {
            if (!(nd is JCHVRF.Model.NextGen.MyNodeCH))
            {
                PointF pt = new PointF(Convert.ToInt64(nd.Location.X), Convert.ToInt64(nd.Location.Y));
                SizeF s1 = new SizeF(Convert.ToInt64(nd.Size.Width + 10), Convert.ToInt64(nd.Size.Height + 15));
                RectangleF recf = new RectangleF(pt, s1);
                if (nd == null) return;
                string text = nd.Text;
                if (Color.Brown.R != 255)
                {
                    Color color = getMediaColor(nd);
                    //Brush brush = new SolidBrush(color);
                    Pen pen = new Pen(color, 0.1f * 0.1f);
                    if (nd.Geometry.GetType().Name == "RectangleGeometry")
                    {
                        Rectangle rect = new Rectangle(Convert.ToInt32(nd.Bounds.X), Convert.ToInt32(nd.Bounds.Y), Convert.ToInt32(nd.Bounds.Width + 10), Convert.ToInt32(nd.Bounds.Height + 15));
                        g.DrawRectangle(pen, rect.X, rect.Y, rect.Width, rect.Height);
                    }
                }
                if (Color.Brown.G != 255)
                {
                    Color color = getMediaColor(nd);
                    Brush brush = new SolidBrush(color);
                    Brush textBrush_piping = new SolidBrush(Color.LightSkyBlue);
                    Rectangle rect = new Rectangle(Convert.ToInt32(nd.Bounds.X), Convert.ToInt32(nd.Bounds.Y), Convert.ToInt32(nd.Bounds.Width + 10), Convert.ToInt32(nd.Bounds.Height + 15));
                    if (nd.Geometry.GetType().Name == "RectangleGeometry")
                    {
                        g.FillRectangle(Brushes.Transparent, rect);
        ...
        public void DrawNodeNextGenPipingForReporting(Graphics g, Node nd, string nodeImageFile, NextGenModel.ImageData data = null, string text = null)
        {
            try
            {

                DrawNodeNextGenPiping(g, nd);
                PointF pt = new PointF(Convert.ToInt64(nd.Location.X + 2), Convert.ToInt64(nd.Location.Y + 5));
                SizeF s1 = new SizeF(Convert.ToInt64(nd.Size.Width + 1), Convert.ToInt64(nd.Size.Height + 2));
                RectangleF recf = new RectangleF(pt, s1);
                Image image = Image.FromFile(nodeImageFile);
                Image nodeImage;
                if (image.Size.Height > 80)
                    nodeImage = new System.Drawing.Bitmap(image, new System.Drawing.Size(60, 55));
                else
                    nodeImage = new System.Drawing.Bitmap(image, new System.Drawing.Size(60, 55)); ;
                int h = nodeImage.Size.Height;
                g.DrawImage(nodeImage, pt);
                PointF ptpoint;
                // if (data.equipmentType == "Indoor")
                //    ptpoint = new PointF(Convert.ToInt64(nd.Location.X + 10), Convert.ToInt64(nd.Location.Y + h - 100));
                //else
                ptpoint = new PointF(Convert.ToInt64(nd.Location.X + 10), Convert.ToInt64(nd.Location.Y + h + 10));
                RectangleF rec = new RectangleF(ptpoint, s1);

                if (nd.Tooltip != null)
                {
                    string[] toolTip = nd.Tooltip.Split(':');
                    if (toolTip.Length > 0 && toolTip.Length > 1)
                    {
                        //Brush brush = Brushes.DarkBlue;
                        Color color = getMediaColor(nd);
                        Brush brush = new SolidBrush(color);
                        g.TextRenderingHint = System.Drawing.Text.TextRenderingHint.SingleBitPerPixelGridFit;
                        g.DrawString(toolTip[1], new Font("Arial Narrow", 8f, System.Drawing.FontStyle.Regular), brush, rec, StringFormatForTextReport);
                    }
                }
                else
                {
                    ...
                    if (toolTip.Length > 0 && toolTip.Length > 1)
                    {
                        ...
                        Brush brush = new SolidBrush(color);
                        g.TextRenderingHint = System.Drawing.Text.TextRenderingHint.SingleBitPerPixelGridFit;
                        g.DrawString(toolTip, new Font("Arial Narrow",8f, System.Drawing.FontStyle.Regular), brush, rec, StringFormatForTextReport);
                    }
                }
                g.ResetTransform();
            }
        ...
        public void DrawNodeNextGenPiping(Graphics g, Node nd, string nodeImageFile, NextGenModel.ImageData data = null, string text =null)
        {
            try {

                DrawNodeNextGenPiping(g, nd);
                PointF pt = new PointF(Convert.ToInt64(nd.Location.X + 2), Convert.ToInt64(nd.Location.Y + 1));
                SizeF s1 = new SizeF(Convert.ToInt64(nd.Size.Width + 1), Convert.ToInt64(nd.Size.Height + 2));
                RectangleF recf = new RectangleF(pt, s1);
                Image image = Image.FromFile(nodeImageFile);
                int h = image.Size.Height;
                g.DrawImage(Image.FromFile(nodeImageFile), pt);
                PointF ptpoint;
                // if (data.equipmentType == "Indoor")
                //    ptpoint = new PointF(Convert.ToInt64(nd.Location.X + 10), Convert.ToInt64(nd.Location.Y + h - 100));
                //else
        ...
        /// <summary>
        /// return string format for report
        /// </summary>

        public static StringFormat StringFormatForTextReport = new StringFormat
        {
            Alignment = StringAlignment.Near,
            LineAlignment = StringAlignment.Near
        };
        public void DrawNodeTextWiringCHbox(Graphics g, Node nd)
        {
            if (nd == null || nd.Text == null)
            {
                return;
            ...
            g.DrawRectangle(pen, rect.X, rect.Y, rect.Width, rect.Height);
            string text = nd.Text;
            ptText = new PointF(Convert.ToInt64(nd.Location.X), Convert.ToInt64(nd.Location.Y+ nd.Size.Height/4));
            Color color = getMediaColor(nd);
            Brush brush = new SolidBrush(color);
            g.TextRenderingHint = System.Drawing.Text.TextRenderingHint.SingleBitPerPixelGridFit;
            g.DrawString(nd.Text, font, brush, ptText, StringFormatForTextReport);
