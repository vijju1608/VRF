...
namespace JCHVRF.BLL
{
    public class OutdoorBLL
    {
        ...
        public OutdoorBLL(string region, string brandCode)
        {
            ...
            _dal = new OutdoorDAL(region, _brandCode);
        }
        ...
        public OutdoorBLL(string region, string brandCode, string mainRegion)
        {
            ...
            _brandCode = brandCode;
            //_dal = new OutdoorDAL(region, productType, _brandCode);
            _dal = new OutdoorDAL(region, _brandCode, mainRegion);
        }
        ...
        public DataTable GetOutdoorListStd(string selectedProductType)
        {
            return _dal.GetOutdoorListStd(selectedProductType);
        }



        public DataTable GetOutdoorListStdSeries(string subregion)
        {
            return _dal.GetOutdoorListStdSeries(subregion);
        }
        ...
        {
            return _dal.GetOutdoorTypeBySeries(series);
        }

        public DataTable GetOutdooTypeBySeriesAndCategory(string series, string productSeries, string productCategory)
        {
            return _dal.GetOutdoorTypeBySeriesProductSeriesCategory(series, productSeries, productCategory);
        }
