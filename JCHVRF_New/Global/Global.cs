...
using NextGenBLL = JCHVRF.BLL.NextGen;
...
namespace JCHVRF_New
{
    ...
    public class Global
    {
        ...
        public static SelectOutdoorResult DoSelectOutdoorODUFirst(JCHVRF.Model.NextGen.SystemVRF curSystemItem, List<RoomIndoor> listRISelected, Project thisProject, out List<string> ERRList, out List<string> MSGList)
        {
            ResetSystemValuesPipingInfo(curSystemItem);
            ...
            if (series == null)
            {
                if (curSystemItem != null)
                    series = listRISelected[0].IndoorItem.Series;
            }
            ...
            NextGenBLL.OutdoorBLL bll = new NextGenBLL.OutdoorBLL(thisProject.SubRegionCode, thisProject.BrandCode);
            ...
            JCHVRF.MyPipingBLL.NextGen.PipingBLL pipBll = new JCHVRF.MyPipingBLL.NextGen.PipingBLL(thisProject);
            ...
            foreach (RoomIndoor ri in listRISelected)
            {
                ...
                {                 
                    ...
                    //if(ri.IndoorItem.Flag==IndoorType)
            ...
            foreach (DataRow r in rows)
            {
                        ...
                        if (curSystemItem.DBCooling <= -10)
                        {
                            switch (ODUmodel)
                            {
                                case "RAS-3HRNM1Q":
                                    ...
                                    {
                                        if (tot_indcap_c <= outstdcap_c)
                                            MSGList.Add("[RAS-3HRNM1Q]" + Language.Current.GetMessage("CURRENT_RATIO_EXCEED") + "[100%]");
                                ...
                                case "RAS-5HYNM1Q":
                                    ...
                                    {
                                        if (tot_indcap_c <= outstdcap_c)
                                            MSGList.Add("[AS-5HYNM1Q]" + Language.Current.GetMessage("CURRENT_RATIO_EXCEED") + "[112%]");
                        ...
                        else
                        {
                            switch (ODUmodel)
                            {
                                case "RAS-3HRNM1Q":
                                    ...
                                    {
                                        if (tot_indcap_c <= outstdcap_c)
                                            MSGList.Add("[RAS-3HRNM1Q]" + Language.Current.GetMessage("CURRENT_RATIO_EXCEED") + "[120%]");
                                ...
                                case "RAS-4HRNM1Q":
                                    ...
                                    if (listRISelected.Count <= 4)
                                    {
                                        ...
                                        {
                                            if (tot_indcap_c <= outstdcap_c)
                                                MSGList.Add("[RAS-4HRNM1Q]" + Language.Current.GetMessage("CURRENT_RATIO_EXCEED") + "[135]");
                                    ...
                                    else if (listRISelected.Count <= 5)
                                    {
                                        ...
                                        {
                                            if (tot_indcap_c <= outstdcap_c)
                                                MSGList.Add("[RAS-4HRNM1Q]" + Language.Current.GetMessage("CURRENT_RATIO_EXCEED") + "[120%]");
                                ...
                                case "RAS-5HYNM1Q":
                                    ...
                                    if (listRISelected.Count <= 4)
                                    {
                                        ...
                                        {
                                            if (tot_indcap_c <= outstdcap_c)
                                                MSGList.Add("[RAS-5HYNM1Q]" + Language.Current.GetMessage("CURRENT_RATIO_EXCEED") + "[130%]");
                                    ...
                                    else if (listRISelected.Count <= 5)
                                    {
                                        ...
                                        {
                                            if (tot_indcap_c <= outstdcap_c)
                                                MSGList.Add("[RAS-5HYNM1Q]" + Language.Current.GetMessage("CURRENT_RATIO_EXCEED") + "[120s%]");
                ...
                if (curSystemItem.SysType == SystemType.OnlyIndoor)
                {
                    ...
                    if (curSystemItem.Ratio < 0.5)
                    {
                        ...
                        if (tot_indcap_c <= outstdcap_c)
                            ...
                            MSGList.Add("[" + curSystemItem.SelOutdoorType + "]" + Language.Current.GetMessage("CURRENT_RATIO_BELOW") + "[" + 50+ "%" + "]");
                        continue;
                    }
                    if (curSystemItem.Ratio > curSystemItem.MaxRatio)
                    {
                        MSGList.Add("["+curSystemItem.SelOutdoorType+"]" + Language.Current.GetMessage("CURRENT_RATIO_EXCEED") + "["+curSystemItem.MaxRatio * 100 + "%]");
                    ...
                    else if (series.Contains("FS(V/Y)N1Q") || series.Contains("JDOH-Q"))
                    {
                        ...
                        if (model_Hitachi == "RAS-6FSVN1Q" || model_Hitachi == "RAS-6FSYN1Q")
                        {
                            ...
                            {
                                MSGList.Add("[" + curSystemItem.SelOutdoorType + "]" + Language.Current.GetMessage("CURRENT_RATIO_EXCEED") + "[120%]");
                ...
                else
                {
                    ...
                    {
                        if (tot_indcap_c <= outstdcap_c)
                            MSGList.Add("[" + curSystemItem.SelOutdoorType + "]" + Language.Current.GetMessage("CURRENT_RATIO_EXCEED") + "[100%]");
                ...
                {
                    string wType;
                    if (!CommonBLL.MeetRoomRequired(ri, thisProject, tolerance, listRISelected, out wType))
                        roomchecked = false;
                    if (!roomchecked)
                        break;
                }
            ...
            **/
            ...
            if ((thisProject != null) && (thisProject.ProductType.Contains("Water Source")))
                ...
                ERRList.Add(Language.Current.GetMessage("CAPCITYREQIREMENT")); 
            //如果按室外机选型得不到正确结果，按室内机选型再试一遍 20161130 by Yunxiao Lin
            if (returnType != SelectOutdoorResult.OK)
                return DoSelectOutdoorIDUFirst(curSystemItem, listRISelected, thisProject, out ERRList);
            return SelectOutdoorResult.Null;
        }
        public static SelectOutdoorResult DoSelectOutdoorManual(JCHVRF.Model.NextGen.SystemVRF curSystemItem, List<RoomIndoor> listRISelected, Project thisProject, out List<string> ERRList)
        {
            ResetSystemValuesPipingInfo(curSystemItem);
            if (ProjectBLL.IsSupportedUniversalSelection(thisProject))
            ...
            if (!roomchecked)
            {  //continue;
                ERRList.Add(Language.Current.GetMessage("CAPCITYREQIREMENT"));//"IND_WARN_CAPActCoolLower IND_WARN_CAPActHeatLower");
                returnType = SelectOutdoorResult.NotMatch;
            }
        ...
        //ACC-SKM-START
        //LOAD POWER OPTIONS FOR HEAT EXCHANGE UNIT INFO.

        public static DataTable InitPowerList(JCHVRF.Model.Project thisProject, string UnitType)
        {
        ...
        public static SelectOutdoorResult DoSelectOutdoorIDUFirst(JCHVRF.Model.NextGen.SystemVRF curSystemItem, List<RoomIndoor> listRISelected, Project thisProject, out List<string> ERRList)
        {
            ResetSystemValuesPipingInfo(curSystemItem);
        ...
        private static CapacitySelectionMode GetCapacitySelectionMode(Project proj)
        {
            ...
            //if (proj.RegionCode == "LA" && proj.SubRegionCode != "LA_BR")
            //{
            //    return CapacitySelectionMode.LA_Except_Brazil;
            //}
            //return CapacitySelectionMode.Normal;
        }
        public static SelectOutdoorResult DoSelectUniversalODUFirst(JCHVRF.Model.NextGen.SystemVRF curSystemItem, List<RoomIndoor> listRISelected, Project thisProject, string series, out List<string> ERRList, out List<string> MSGList)
        {
            ResetSystemValuesPipingInfo(curSystemItem);
            ERRList = new List<string>();
            MSGList = new List<string>();
            ...
            if (curSystemItem != null && curSystemItem.IDUFirst && !series.Contains("IVX"))
                return DoSelectOutdoorIDUFirst(curSystemItem, listRISelected, thisProject, out ERRList);
            NextGenBLL.OutdoorBLL bll = new NextGenBLL.OutdoorBLL(thisProject.SubRegionCode, thisProject.BrandCode, thisProject.RegionCode);
            double tolerance = 0.05;
                        ...
                        if (curSystemItem.DBCooling <= -10)
                        {
                            switch (ODUmodel)
                            {
                                ...
                                case "RAS-5HYNM1Q":
                                    ...
                                    {
                                        if (tot_indcap_c <= outstdcap_c)
                                            MSGList.Add("[RAS-5HYNM1Q]" + Language.Current.GetMessage("CURRENT_RATIO_EXCEED") + "[112%]");
                                       // MSGList.Add(Msg.MSGLIST_GENERAL_INFO2("RAS-5HYNM1Q", "112%"));
                                        continue;
                                    }
                                    break;
                            ...
                            switch (ODUmodel)
                            {
                                ...
                                case "RAS-5HYNM1Q":
                                    ...
                                    else if (listRISelected.Count <= 5)
                                    {
                                        ...
                                        {
                                            if (tot_indcap_c <= outstdcap_c)
                                                MSGList.Add("[RAS-5HYNM1Q]" + Language.Current.GetMessage("CURRENT_RATIO_EXCEED") + "[120%]");
                                           // MSGList.Add(Msg.MSGLIST_GENERAL_INFO2("RAS-5HYNM1Q", "120%"));
                                            continue;
                                        }
                                    }
        ...
        public static SelectOutdoorResult DoSelectUniversalOduManual(JCHVRF.Model.NextGen.SystemVRF curSystemItem, List<RoomIndoor> listRISelected, Project thisProject, string series, out List<string> ERRList)
        {
            ResetSystemValuesPipingInfo(curSystemItem);
            ERRList = new List<string>();
            ERRList.Clear();    // 每次选型前清空错误记录表
        ...
        private static SelectOutdoorResult DoSelectOutdoorIDUFirstManual(JCHVRF.Model.NextGen.SystemVRF curSystemItem, List<RoomIndoor> listRISelected, Project thisProject, out List<string> ERRList)
        {
            ResetSystemValuesPipingInfo(curSystemItem);
            DateTime t1 = DateTime.Now;
            NextGenBLL.OutdoorBLL bll = new NextGenBLL.OutdoorBLL(thisProject.SubRegionCode, thisProject.BrandCode);
        ...
        private static void CalacIndoorActualCapacity(NextGenModel.SystemVRF curSystemItem, List<RoomIndoor> listRISelected,
        ...
        /// <summary>
        /// Reset values to default for piping rules
        /// </summary>
        /// <param name="curSystemItem"></param>
        private static void ResetSystemValuesPipingInfo(NextGenModel.SystemVRF curSystemItem)
        {
            curSystemItem.TotalPipeLength = 0;
            curSystemItem.PipeActualLength = 0;
            //curSystemItem.PipeEquivalentLength = 0;
            //curSystemItem.FirstPipeLength = 0;
            curSystemItem.ActualMaxMKIndoorPipeLength = 0;
            curSystemItem.MaxUpperHeightDifferenceLength = 0;
            curSystemItem.MaxLowerHeightDifferenceLength = 0;
            curSystemItem.MaxIndoorHeightDifferenceLength = 0;
            curSystemItem.MaxCHBox_IndoorHighDiffLength = 0;
            curSystemItem.MaxSameCHBoxHighDiffLength = 0;
            curSystemItem.MaxCHBoxHighDiffLength = 0;
            if (!curSystemItem.IsInputLengthManually)
            {
                curSystemItem.PipeEquivalentLength = JCHVRF.Model.SystemSetting.UserSetting.pipingSetting.pipingEqLength;
                curSystemItem.PipeEquivalentLengthbuff = JCHVRF.Model.SystemSetting.UserSetting.pipingSetting.pipingEqLength;
                curSystemItem.FirstPipeLength = JCHVRF.Model.SystemSetting.UserSetting.pipingSetting.firstBranchLength;
                curSystemItem.FirstPipeLengthbuff = JCHVRF.Model.SystemSetting.UserSetting.pipingSetting.firstBranchLength;
                curSystemItem.HeightDiff = JCHVRF.Model.SystemSetting.UserSetting.pipingSetting.pipingHighDifference;
                curSystemItem.PipingLengthFactor = JCHVRF.Model.SystemSetting.UserSetting.pipingSetting.pipingCorrectionFactor;
                curSystemItem.PipingPositionType = JCHVRF.Model.SystemSetting.UserSetting.pipingSetting.pipingPositionType;
            }
        }
    }
}
